        ...
        <div className="mx-auto max-w-6xl px-4 pt-12 pb-16 sm:px-6 sm:pb-24 lg:px-8 lg:pb-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="text-3xl leading-tight font-bold tracking-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
              Mais alunos. Mais pacientes. Mais clientes na sua barbearia. Sem
              mensalidade.
            </h1>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            <h2 className="text-2xl font-bold text-white sm:text-3xl md:text-4xl">
              Não tem presença digital forte? O cliente treina, consulta ou
              corta cabelo no concorrente.
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-400">
              O público pesquisa tudo pelo celular antes de decidir. Quem não
              aparece com força perde. Simples assim.
            </p>
          </div>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-card border-white/5 rounded-xl border p-6">
              ...
              <p className="mt-2 text-gray-400">
                Sem informações claras, telefone escondido, preço difícil? A
                pessoa vai embora. Cliente quer tudo fácil, direto e confiável.
              </p>
            </div>
            <div className="bg-card border-white/5 rounded-xl border p-6">
              <div className="bg-cyan/10 text-cyan flex h-12 w-12 items-center justify-center rounded-lg text-xl font-bold">
              ...
              <h3 className="mt-4 text-lg font-semibold text-white">
                Sua academia, clínica ou barbearia não está no topo da busca? O
                dinheiro vai pra outro.
              </h3>
              <p className="mt-2 text-gray-400">
                Se o Google não mostra seu nome, seu concorrente agradece.
                Presença forte garantida, você é encontrado primeiro.
              </p>
            </div>
            <div className="bg-card border-white/5 sm:col-span-2 lg:col-span-1 rounded-xl border p-6">
              ...
              <p className="mt-2 text-gray-400">
                Site velho, genérico, sem profissionalismo, derruba sua
                autoridade. Valorize a imagem da sua academia, clínica ou
                barbearia.
              </p>
            </div>
          </div>
      ...
      <section className="bg-black py-16 sm:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-400">
              Seu site pronto. Seu nome no topo. Autoridade de verdade.
              Investimento único. Zero mensalidade.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
            <article className="bg-card border-white/5 hover:border-cyan/30 overflow-hidden rounded-2xl border transition-colors">
              ...
              <div className="p-8">
                ...
                <p className="mt-3 text-gray-400">
                  Páginas de Alta Conversão para captar mais alunos, clientes ou
                  pacientes. Facilite o contato. Aumente seu faturamento sem
                  enrolação.
                </p>
              </div>
            </article>
            <article className="bg-card border-white/5 hover:border-cyan/30 overflow-hidden rounded-2xl border transition-colors">
              ...
              <div className="p-8">
                ...
                <p className="mt-3 text-gray-400">
                  Sua academia, clínica ou barbearia fica fácil de achar. Mais
                  gente chegando todos os dias. Mais credibilidade.
                </p>
              </div>
            </article>
            <article className="bg-card border-white/5 hover:border-cyan/30 overflow-hidden rounded-2xl border transition-colors">
              ...
              <div className="p-8">
                ...
                <p className="mt-3 text-gray-400">
                  Seu site rápido e bonito no smartphone. Cliente chega, se sente
                  seguro e decide fácil.
                </p>
              </div>
            </article>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold tracking-tight text-white md:text-4xl">
              Investimento único. Mais lucro para sua academia, clínica ou
              barbearia.
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-zinc-300">
              Valorize o negócio que você construiu. Resultados reais. Zero
              mensalidade. Você no controle.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
            <div className="group relative overflow-hidden rounded-xl border border-cyan-400/30 bg-zinc-900/80 p-8 shadow-lg transition hover:shadow-cyan-500/30">
              ...
              <p className="relative z-10 mb-5 text-zinc-300">
                Gasta com anúncio ou divulgação? Precisa de páginas que convertem
                visitas em mensagens no WhatsApp e ligações. Lotação garantida
                em pouco tempo.
              </p>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-emerald-400/30 bg-zinc-900/80 p-8 shadow-lg transition hover:shadow-emerald-400/30">
              ...
              <p className="relative z-10 mb-5 text-zinc-300">
                Seu site institucional mostra credibilidade e destaca seus
                diferenciais. O cliente sente confiança já no primeiro clique.
              </p>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-fuchsia-400/30 bg-zinc-900/80 p-8 shadow-lg transition hover:shadow-fuchsia-400/30">
              ...
              <p className="relative z-10 mb-5 text-zinc-300">
                Sistemas de gestão para rotinas: cadastros, agendamentos,
                controle do jeito que seu time usa. Seu nome, sua marca. Sem
                mensalidade.
              </p>
          ...
          <div className="mt-16 flex flex-col items-center">
            <div className="flex max-w-2xl flex-col items-center rounded-lg border border-cyan-400/20 bg-zinc-900/80 px-8 py-6 shadow shadow-cyan-500/10">
              ...
              <p className="mb-4 text-center text-zinc-200">
                Cada negócio é único. Entendemos seu desafio e trazemos a solução
                para sua academia, clínica ou barbearia. Fale direto com
                especialista.
              </p>
      ...
      <section className="bg-surface border-white/5 border-t py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">
            Quer mais clientes de verdade para sua barbearia, clínica ou
            academia?
          </h2>
          <p className="mt-4 text-lg text-gray-400">
            Clique e fale direto. Solução sem enrolação para dono de negócio
            sério.
          </p>
          <a
            href={WHATSAPP_ORCAMENTO_EXCLUSIVO_HREF}
