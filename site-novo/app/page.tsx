...
const WHATSAPP_BUDGET_HREF = `https://api.whatsapp.com/send?phone=${WHATSAPP_NUMBER}&text=${encodeURIComponent(WHATSAPP_BUDGET_MESSAGE)}`;
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[100] flex items-end justify-between gap-3 px-4 pb-6 sm:px-6">
        <a
          href={WHATSAPP_BUDGET_HREF}
          target="_blank"
          rel="noopener noreferrer"
          className="pointer-events-auto bg-cyan text-black shadow-cyan-glow hover:opacity-90 focus:ring-cyan focus:ring-offset-black flex h-14 max-w-[min(100%,calc(100vw-5.5rem))] shrink-0 items-center justify-center rounded-full px-5 text-sm font-semibold transition-all hover:scale-[1.02] focus:ring-2 focus:ring-offset-2 focus:outline-none sm:px-6 sm:text-base"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="pointer-events-auto bg-cyan text-black shadow-cyan-glow hover:opacity-90 focus:ring-cyan focus:ring-offset-black flex h-14 w-14 shrink-0 items-center justify-center rounded-full transition-all hover:scale-105 focus:ring-2 focus:ring-offset-2 focus:outline-none"
